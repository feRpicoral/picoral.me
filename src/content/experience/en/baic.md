...
highlights:
  ...
  - Created a mobile application with integrated AI object detection for in-field data collection.
  - Implemented a web-based platform enabling researchers to run studies using AR glasses.
tech:
  - TypeScript
  - React
  - React Native
