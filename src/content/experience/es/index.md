...
education:
  - degree: Licenciatura en Ciencias de la Computación
    ...
    detail: GPA de especialidad 3.9 / 4.0
    period:
      start: 2022-08-01T00:00:00.000Z
      end: 2026-05-01T00:00:00.000Z
    location: 'Boulder, CO'
  - degree: Minor en Administración de Empresas
    school: University of Colorado Boulder
    detail: GPA 3.9 / 4.0
    period:
...
work:
  ...
  - company: Trius
    ...
    summary: >-
      Pasó de CFO a Asesor de Directorio en Trius para enfocarse en la pasantía
      de Google en Nueva York.
    highlights:
      - Continuó como asesor del equipo fundador tras dejar el rol de CFO.
    tech: []
    type: founder
  ...
  - company: Google
    ...
    summary: >-
      Trabajo full-stack de funcionalidades en la Data Bridge Console de Google
      — backend, RPCs, frontend en AngularDart y un backfill de alto rendimiento
      en Spanner.
    highlights:
      - >-
        Diseñó e implementó etiquetas para la Data Bridge Console de Google,
        mejorando la identificación de recursos y la eficiencia de búsqueda.
  ...
  - company: 'Brain, AI, and Child Laboratory — CU Boulder'
    ...
    summary: >-
      Pasante de investigación en el laboratorio BAIC del Dr. Tom Yeh,
      desarrollando el software interno necesario para ejecutar estudios de
      interacción humano-IA — desde recolección de datos en campo hasta
  ...
  - company: Google
    ...
    highlights:
      - >-
        Implementó un nuevo framework de debug para Android Messages en Kotlin,
