...
<ProjectImage src="/src/assets/projects/desvia/navigation.png" alt="Desvia navigation screen on a phone: a map with a route to Aeroporto de Congonhas, a 22-minute ETA card, and callouts reading 'Contorna 1 área sua — Feira de domingo' and 'Trânsito livre'." caption="Navigating with a route that routes around one of the driver's own areas — a Sunday street market — while traffic is clear." size="prose" />
